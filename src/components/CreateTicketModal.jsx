...
export default function CreateTicketModal({ isOpen, onClose, currentUser, onTicketCreated, pharmaciesList = [] }) {
        ...
        try {
            ...
            if (rawDraft) {
                ...
                if (isFresh && hasContent) {
                    ...
                    if (draft.selectedPharmacy && currentUser?.role === 'admin') setSelectedPharmacy(draft.selectedPharmacy);
    ...
    }, [isOpen, wizardStep, selectedPharmacy, requesterRole, ticketPriority, ticketObjective, ticketAdditionalInfo, requestType, stepSpecificData]);
                        ...
                        <>
                            ...
                            <div className="input-group">
                                ...
                                <div 
                                    ...
                                    style={{
                                        border: validationErrors.logoRequired ? '2px dashed #ef4444' : '2px dashed rgba(99, 102, 241, 0.35)',
                                        borderRadius: '16px',
                                        padding: '24px 16px',
                                        textAlign: 'center',
